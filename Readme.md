...
# Комментарии.
    ...
    и в других местах)
        Валидацию данных нужно убрать в другой класс и провести ее до работы метода doOperation(). Будет создан такой класс, но валидация в другом виде останется в этом методе, так как точно не известно какая реально архитектура приложения и используется ли какой-нибудь фреймворк.
